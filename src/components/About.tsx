        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56, alignItems: 'start' }}
          ...
          >
            ...
            <ul style={{ listStyle: 'none', padding: 0, margin: '0 0 28px', display: 'flex', flexDirection: 'column', gap: 8 }}>
              {personalInfo.summaryDetails.map((detail, i) => (
                <li key={i} style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
                  <span style={{ color: '#4285F4', flexShrink: 0, fontSize: '0.6rem', marginTop: 5, fontWeight: 700 }}>▸</span>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              <a href={personalInfo.linkedin} target="_blank" rel="noopener noreferrer"
                className="cta-btn cta-blue" style={{ display: 'inline-flex', alignItems: 'center', gap: 7 }}>
              ...
              <a href={personalInfo.github} target="_blank" rel="noopener noreferrer"
                className="cta-btn cta-outline" style={{ display: 'inline-flex', alignItems: 'center', gap: 7 }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor">
